...
the **bi8s-go** community a harassment-free experience for everyone, regardless
...
requests, discussions, chat, and events) and also when an individual is
officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainers at **conduct@bi8s.local**. All complaints
...
1. **Correction** — Private, written warning for unprofessional or unwelcome
   behavior, with clarity around the violation.
