...
// AWSCredentials carries the AWS region and optional static access keys used
// to construct an aws.Config. Empty AccessKey/SecretAccessKey causes the SDK
// to fall back to the default credential chain (IRSA, instance role, env).
