...
func TestRouter_RouteSnapshot(t *testing.T) {
	...
	expected := []string{
		...
		"POST   /v1/a/people/",
		"PATCH  /v1/a/people/{peopleId}",
		"DELETE /v1/a/people/{peopleId}",
		"PUT    /v1/a/person/profile/{peopleId}",
		"PUT    /v1/a/person/backdrop/{peopleId}",
		"POST   /v1/a/person/attributes/{attributeId}/add",
		"POST   /v1/a/person/attributes/{attributeId}/remove",
