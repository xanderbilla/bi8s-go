...
// ParsePersonFromForm builds a Person struct from parsed multipart form data.
...
// parseRoles parses comma-separated role values into EntityType slice
...
// parseMeasurements parses measurement fields from form data
